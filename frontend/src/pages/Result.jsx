  ...
  return (
    <>
      ...
      <div className="page-container">
        <div className={`result-wrap ${rankClass}`}>
          <div className="result-rank-section">
            ...
            <div className="result-rank-ring">
          ...
          <div className="result-stats">
            <div className="result-stat">
              <div className="result-stat-n result-stat-n-rank">
                {result.score}
                <span className="result-stat-den">/{result.totalQuestions}</span>
              </div>
            ...
            <div className="result-stat">
              <div className="result-stat-n result-stat-n-gold">
                {result.isFirstAttempt ? `+${result.xpEarned} XP` : '+0 XP'}
              </div>
              <div className="result-stat-l">XP EARNED</div>
            </div>
            <div className="result-stat">
              <div className="result-stat-n result-stat-n-cyan">
